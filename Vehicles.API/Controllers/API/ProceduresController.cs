...
{
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//si esta primero significa que todos los metodos son auntenticado se puede colocar a nivel de metodo
    ...
    public class ProceduresController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutProcedure(int id, Procedure procedure)
        {
            ...
            catch (DbUpdateException dbUpdateException)//se verifica si esta duplicada
            {
