...
namespace Vehicles.API.Controllers
{
    public class AccountControllers : Controller
    {
        ...
        public AccountControllers(IUserHelper userHelper, DataContext context, ICombosHelper combosHelper,
        ...
        {
            User user = await _userHelper.GetUserAsync(User.Identity.Name); //para sacar el usuario logueado
            if (user == null)
            {
                return NotFound();
            }
